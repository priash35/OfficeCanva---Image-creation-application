	...
	<!--<script src="<?php echo base_url()?>assets/js/jquery-1.4.2.js"></script>-->
	<script src="<?php echo base_url()?>assets/js/lib/peity/jquery.peity.min.js"></script>
	<script src="<?php echo base_url()?>assets/js/lib/table-edit/jquery.tabledit.min.js"></script>

	<script src="<?php echo base_url()?>assets/js/lib/bootstrap/bootstrap.min.js"></script>
	<script src="<?php echo base_url()?>assets/js/plugins.js"></script>

	<script src="<?php echo base_url()?>assets/js/lib/html5-form-validation/jquery.validation.min.js"></script>
	...
	<script src="<?php echo base_url(); ?>assets/js/lib/bootstrap/bootstrap.min.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/plugins.js"></script>
	<script src="<?php echo base_url(); ?>assets/js/jquery.fontselect.js"></script>
