...
<head lang="en">
	...
	<![endif]-->
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/fontselect.css">
	...
	<header class="site-header">
	    <div class="container-fluid">
	       ...
	       <a href="#" class="site-logo">
	         ...
	         <img class="hidden-md-down" src="<?php echo base_url(); ?>assets/img/logos.png" alt="">
				
	           <img class="hidden-lg-up" src="<?php echo base_url(); ?>assets/img/logos.png" alt="">
	        </a>
			...
			<div class="dropdown user-menu">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
	                            ...
	                            <a class="dropdown-item" href="<?php echo base_url();?>/login/logout"><span class="font-icon glyphicon glyphicon-log-out"></span>Logout</a>
	                        </div>
	                    </div>
	        ...
	        <div class="site-header-content">
	            <div class="site-header-content-in">
					...
					<!--<h3 style="width:500px; margin: 0;">Yashallay Admin Panel</h3>-->
	                <!--<div class="site-header-shown">
	...
	<nav class="side-menu">
	    <ul class="side-menu-list">
	        <li class="grey with-sub">
	            <a href="<?php echo base_url().'Welcome/index';?>"><span>
	                <i class="font-icon font-icon-dashboard"></i>
	                <span class="lbl">Dashboard</span>
	            </span></a>        
	        </li>
			<li class="grey with-sub"><a href="<?php echo base_url().'Welcome/add_emp';?>"><span><i class="font-icon font-icon-user" aria-hidden="true"></i><span class="lbl">Employees</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'Welcome/add_client';?>"><span><i class="font-icon font-icon-user" aria-hidden="true"></i><span class="lbl">Clients</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'Welcome/client_Gallary';?>"><span><i class="font-icon font-icon-page" aria-hidden="true"></i><span class="lbl">Images</span></span></a></li>		
			<!--<li class="grey with-sub"><a href="<?php echo base_url().'admin/add_quiz';?>"><span><i class="font-icon font-icon-pen" aria-hidden="true"></i><span class="lbl">Add Quiz</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'admin/show_country';?>"><span><i class="font-icon font-icon-earth" aria-hidden="true"></i><span class="lbl">Add Country</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'admin/show_city';?>"><span><i class="font-icon font-icon-pin" aria-hidden="true"></i><span class="lbl">Add City</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'admin/show_language';?>"><span><i class="font-icon font-icon-pen-square" aria-hidden="true"></i><span class="lbl">Add Language</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'admin/add_notification';?>"><span><i class="font-icon font-icon-mail" aria-hidden="true"></i><span class="lbl">Add Notifications</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'admin/add_franchise';?>"><span><i class="font-icon font-icon-build" aria-hidden="true"></i><span class="lbl">Add Franchise</span></span></a></li>
	            -->
	    </ul>
	    </section>
	</nav><!--.side-menu-->