				...
				<div class="card-block">
					...
					<div class="row m-t-lg">
						...
						<div class="tbl-cell">
							...
							<form name="myform" id="myform" action="<?php echo base_url()?>Welcome/add_clientdata" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="form-control-wrapper">
										...
										<textarea style="width:100%;" class="form-control" type="text" id ="address" name="address" placeholder="Enter client address"></textarea>
									</div><br>
									
									<label class="form-label" for="signup_v1-username">Email Id:</label>
									<div class="form-control-wrapper">
										<input type="email" class="form-control" name="email" placeholder="Enter client email id" required>
									</div>
									<br>
									...
									<div class="form-control-wrapper">
										<input type="text" class="form-control" name="contact" placeholder="Enter client contact number" required>
									</div><br>
									
									<label class="form-label" for="signup_v1-username">Business Category:</label>
									<div class="form-control-wrapper">
										<input type="text" class="form-control" name="b_cat" placeholder="Enter business category (Example: IT)" required>
									</div><br>
									
									<label class="form-label" for="signup_v1-username">Client Image:</label>
									<div class="form-control-wrapper">
									...
									<div class="form-control-wrapper">
										<input type="text" class="form-control" name="website" placeholder="Enter course Fee" required>
									</div><br>
																		
								</div>
								<div class="form-group">
									<button type="submit" name="add_client" class="btn">Save</button>
								</div>
							</form>
