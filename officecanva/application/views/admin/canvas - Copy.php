...
<div class="page-content">
	<div class="container-fluid">
			...
			<form name="myform" id="myform" action="<?php //echo base_url()?>" method="post">
				<div class="col-md-8">
					<div class="form-group col-md-6">
						...
						<select name="client" id="client" class="form-control" style="width:90%">
					...
					<div class="form-group col-md-6">
						...
						<select name="client1" id="client1" class="form-control" style="width:90%">
									<option value="0">---Select your client---</option>
											<?php
												foreach ($clients as $value1) 
													{
		...
		<div style="position:relative; top:230px; left:-130px;">
...
$(document).ready(function() {
    ...
    $("#client").change(function(){ 
			...
			$.ajax({  
				...
				ctx4.fillText(c_name, 370, 25);
				ctx4.fillText(emailid, 370, 40);
				ctx4.fillText(con, 370, 60);
				ctx4.fillText(web,370, 75);					
				//client logo
