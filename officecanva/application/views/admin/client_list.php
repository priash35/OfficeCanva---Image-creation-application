				...
				<div class="card-block">
					<div class="row">
						<div class="col-lg-12">
							...
							<a href="<?php echo base_url();?>Welcome/add_clientdata"><button class="btn btn-inline btn-primary btn-lg">Add New Client</button></a><hr>
							<div class="heading"><h2>Client List</h2></div>
							...
							<table class="table table-bordered table-hover table-responsive"> 
								...
								<tbody>
									...
									<?php $i=1; foreach($clients as $post){?>
											<tr>
													<td><?php echo $i;?></td>
													...
													<td><?php echo $post->business_category;?></td>
													<td><?php echo $post->website_url;?></td>
													<td><a  href="<?php echo base_url(); ?>Welcome/EditClientList/<?php echo $post->id;?>"><span class="tabledit-edit-button btn btn-sm btn-default glyphicon glyphicon-pencil"></span></a>
													<a  href="<?php echo base_url(); ?>Welcome/DeleteClientList/<?php echo $post->id;?>"><span class="tabledit-edit-button btn btn-sm btn-default glyphicon glyphicon-trash"></span></a></td>
