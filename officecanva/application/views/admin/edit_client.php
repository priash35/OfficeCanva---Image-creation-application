						...
						<div class="tbl-cell">
							...
							<form name="myform" id="myform" action="<?php echo base_url()?>Welcome/update_clientdata" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="form-control-wrapper">
										<input type="file" class="form-control img-circle" name="c_img" >
										<input type="hidden" name="c_image" value="<?php echo $row->photo;?>" /><br>
										<img class="img-circle" src="<?php echo $row->photo;?>" style="width:200px; height:150px;"/>
									</div><br>
