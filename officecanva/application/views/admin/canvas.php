		...
		<div class="row col-md-8">	
			<div style="position:relative; left:25px;">
				<div id="canvasesdiv">
					...
					<canvas id="cnv4" style="z-index: 2;position:absolute;left: 390px;top:550px;" height="100px" width="300">
					</canvas>
					<canvas id="cnv5" class="movable_div" style="z-index: 10;position: absolute;left: 60px;top: 150px;" height="300px" width="500px">
					</canvas>
					<canvas id="cnv6" style="z-index: 2; position:absolute; left:40px; top:550px;" height="100px" width="600">
					</canvas>
				</div>				
			</div>
			<br><br>
...
$(document).ready(function() {
    ...
    $("#client").change(function(){ 
			...
			$.ajax({  
				...
				ctx4.fillText(c_name, 100, 25);
				ctx4.fillText(emailid, 100, 40);
				ctx4.fillText(con, 100, 60);
				ctx4.fillText(web,100, 75);					
				//client logo
				...
				base_image1.src = c_logo;
				base_image1.onload = function(){
				ctx4.drawImage(base_image1, 430,15,150,50);}	
				...
				base_image.onload = function(){
					...
					ctx4.drawImage(base_image, 0,0,80,80);
					ctx4.restore();
...
<script type="text/javascript">	
	...
	$(function(){	
			...
			$('#dw').click(function(){
				var elem = document.getElementById("cnv5");
				var leftCSSprop = window.getComputedStyle(elem, null).getPropertyValue("left");
				var topCSSprop = window.getComputedStyle(elem, null).getPropertyValue("top");
				//alert(leftCSSprop);
				//alert(topCSSprop);
				/* var lt = 100;
				var tp = 150;
				 alert(test_two); */
									...
									//alert(tp);
										...
										ctx3.drawImage(cnv5, lt, tp);
										ctx3.drawImage(cnv6, 10, 550); 
										//alert(lt);
										//alert(tp);
					...
					if(leftCSSprop == '60px' && topCSSprop == '150px' )
					{
						//alert('Variable "lt" is undefined.');
						//var tp = 550;
						//var tp = 20;
						var can3 = document.getElementById('cnv');
						var ctx3 = can3.getContext('2d');
