		...
		<section class="card">
			<div class="card-block">
				<div class="row m-t-lg">
					...
					<div class="heading"><h2>Client's Gallary</h2></div>
					<?php foreach($result as $row) {
						?>
					<div id="g1" class="gallery" >			
...
$(document).ready(function() {  
	...
	$("#g1 img").click(function(){	
		...
		$.ajax({ 
				url:"<?php echo base_url();?>Client/client_image_data",  
				...
				success:function(data){ 
					...
					$(".cl_img").click(function(){	
						...
						window.location.href= "<?php echo site_url('Client/image_data');?>?id="+imageId;	
