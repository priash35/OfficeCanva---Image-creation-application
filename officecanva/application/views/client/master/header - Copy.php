	...
	<header class="site-header">
	    <div class="container-fluid">
	        ...
	        <a href="#" class="site-logo">
	         ...
	         <img class="hidden-md-down" src="<?php echo base_url(); ?>assets/img/logo.png" alt="">
	...
	<nav class="side-menu">
	    <ul class="side-menu-list">
	        <li class="grey with-sub">
	            ...
	            <ul>
	                <li><a href="<?php echo base_url().'page/add_page';?>"><span class="lbl">Add Page</span></a></li>
	            </ul>
				<!--<ul>
	                <li><a href="<?php //echo base_url().'page/editPage';?>"><span class="lbl">Edit Page</span></a></li>
	            </ul>-->
				<ul>
	                <li><a href="<?php echo base_url().'page/add_element';?>"><span class="lbl">Add Element</span></a></li>
	            </ul>
	        </li>
	      </ul>
	    </section>
