	...
	<nav class="side-menu">
	    <ul class="side-menu-list">
	        <li class="grey with-sub">
	            <a href="<?php echo base_url().'Client/index';?>"><span>
	                <i class="font-icon font-icon-dashboard"></i>
	                <span class="lbl">Dashboard</span>
	            </span></a>        
	        </li>			
			<li class="grey with-sub"><a href="<?php echo base_url().'Client/client_Gallary';?>"><span><i class="font-icon font-icon-page" aria-hidden="true"></i><span class="lbl">Images</span></span></a></li>		
