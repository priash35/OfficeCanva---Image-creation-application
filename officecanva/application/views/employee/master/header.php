	...
	<header class="site-header">
	    <div class="container-fluid">
	       ...
	       <!--  <a href="#" class="site-logo">
	         ...
	         <img class="hidden-md-down" src="<?php echo base_url(); ?>assets/img/logo1.png" alt="">
	...
	<nav class="side-menu">
	    <ul class="side-menu-list">
	        <li class="grey with-sub">
	            <a href="<?php echo base_url().'Employee/index';?>"><span>
	                <i class="font-icon font-icon-dashboard"></i>
	                <span class="lbl">Dashboard</span>
	            </span></a>        
	        </li>			
			<li class="grey with-sub"><a href="<?php echo base_url().'Employee/add_client';?>"><span><i class="font-icon font-icon-user" aria-hidden="true"></i><span class="lbl">Clients</span></span></a></li>
			<li class="grey with-sub"><a href="<?php echo base_url().'Employee/client_Gallary';?>"><span><i class="font-icon font-icon-page" aria-hidden="true"></i><span class="lbl">Images</span></span></a></li>		
